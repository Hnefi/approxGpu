...
__global__ void resizeKernel_st2(int* outputPixels,int* intermediate, int* weightedKernel,uint height, uint width,uint resizedRows,uint resizedCols,cudaTextureObject_t tref,int NUM_TEX /*, other arguments */)
{
    // assign id's
